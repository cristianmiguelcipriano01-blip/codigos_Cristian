...
opcao = int("qual sua opcao? ")

if opcao == 1:
    cotacao = float(input("digite a contação do dollar"))
    valor_em_dollar = float(input("quantos dollares você vai converter"))
    ...
    opcao == 2
    cotacao = float(input("digite a contação do dollar"))
    valor_em_reais = float(input("quantos dollares você vai converter"))
    formula = cotacao / valor_em_reais
    print (f"o valor em  é {formula}")
